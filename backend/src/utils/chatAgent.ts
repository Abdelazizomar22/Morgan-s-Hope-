...
function buildSystemPrompt(
  ...
  if (ar) {
    return [
      ...
      'Project identity: Morgan\'s Hope is a graduation project at the Higher Institute of Computer Science & Information Systems. The website, chatbot, and original idea were created by Abdelaziz Omar.',
      'Future vision: Morgan\'s Hope aims to become a full chest-disease screening platform that can support every available chest disease detectable from medical imaging and eventually accept more scan types beyond CT and X-Ray.',
