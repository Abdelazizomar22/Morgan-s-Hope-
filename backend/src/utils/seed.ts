...
const hospitalsData = [
  {
    ...
    beds: '750+',
    expertise: ['CT Lung Cancer Classes', 'Potential Malignancy Findings', 'Lung Cancer', 'Chemotherapy', 'Radiation', 'Surgery', 'Bone Marrow'],
  ...
  },
  {
    ...
    beds: '500+',
    expertise: ['CT Lung Cancer Classes', 'Potential Malignancy Findings', 'Lung Cancer', 'CT Biopsy', 'Chemotherapy', 'Radiation', 'Palliative Care'],
  ...
  },
  {
    ...
    beds: '300+',
    expertise: ['Potential Malignancy Findings', 'Cardiac Conditions', 'VATS Surgery', 'PET-CT', 'Immunotherapy', 'Targeted Therapy', 'Palliative Care'],
  ...
  },
  {
    ...
    beds: '280+',
    expertise: ['CT Lung Cancer Classes', 'Potential Malignancy Findings', 'Lung Cancer', 'Chemotherapy', 'Radiation', 'Nuclear Medicine', 'Surgery'],
  ...
  },
  {
    ...
    beds: '320+',
    expertise: ['CT Lung Cancer Classes', 'Potential Malignancy Findings', 'Lung Cancer', 'Bronchoscopy', 'CT Biopsy', 'Chemotherapy', 'Radiation', 'Surgery'],
  ...
  },
  {
    ...
    beds: '400+',
    expertise: ['Pulmonary Infection', 'COPD-related Findings', 'Fibrotic Lung Disease', 'Pleural Diseases', 'TB Evaluation', 'Potential Malignancy Findings', 'Thoracic Surgery', 'Pulmonology', 'Chemotherapy', 'Radiation', 'Endoscopy'],
  ...
  },
  {
    ...
    beds: '380+',
    expertise: ['Potential Malignancy Findings', 'Cardiac Conditions', 'PET-CT', 'MRI', 'Tumor Board', 'Chemotherapy', 'Immunotherapy'],
  ...
  },
  {
    ...
    beds: '1200+',
    expertise: ['Pulmonary Infection', 'COPD-related Findings', 'Fibrotic Lung Disease', 'Pleural Diseases', 'TB Evaluation', 'Potential Malignancy Findings', 'Thoracic Surgery', 'Pulmonology', 'CT Scan', 'Biopsy', 'Chemotherapy'],
